...
import com.shatteredpixel.shatteredpixeldungeon.actors.hero.abilities.miyu.Flashbang;
...
//			new TalismanOfForesight().identify().upgrade(10).collect();
			...
			//new YuzuRemain().collect();
			new IzunaRemain().collect();
		}
...
//	}
	...
	private static void initMiyu(Hero hero) {
		SR_T1 srT1 = new SR_T1();
		(hero.belongings.weapon = srT1).identify();
	...
	public boolean isUnlocked(){
		...
		switch (this){
			case WARRIOR: case MAGE: case ROGUE: case HUNTRESS: case DUELIST: case CLERIC:
				return false;
			default:
				return true;
		}
